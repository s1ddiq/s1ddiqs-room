...
const buttonVariants = cva(
  "font-head transition-all outline-hidden cursor-pointer flex items-center",
  {
    variants: {
      variant: {
        default:
          "shadow-md hover:shadow-xs bg-yellow-300 text-black border-2 border-black hover:bg-primary-hover",
        secondary:
          "bg-black text-white shadow-red-500 hover:-translate-y-1 hover:shadow-md",
        outline:
